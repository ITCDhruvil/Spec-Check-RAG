...
start "Spec Check Backend" cmd /k "cd /d %ROOT%backend && call venv\Scripts\activate.bat && set EXTRA_CORS_ORIGINS=!EXTRA_CORS_ORIGINS! && python serve.py %BIND_HOST% !BACKEND_PORT!"
